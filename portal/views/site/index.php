                ...
                <div class="indicators-wrapper">
                    <ol class="carousel-indicators fonts0">
                        <li data-target="#main-carousel" data-slide-to="0"
                            class="active"><?= Html::img('@web/img/slides/01.jpg') ?></li>
                        <li data-target="#main-carousel"
                            data-slide-to="1"><?= Html::img('@web/img/slides/01.jpg') ?></li>
                        <li data-target="#main-carousel"
                            data-slide-to="2"><?= Html::img('@web/img/slides/01.jpg') ?></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section id="slide-2" class="sections">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 text-right col-fTitle"><a>
                ...
                foreach ($recommendedProducts as $recommendedProduct) {
                    ...
                    <div class="col-lg-4 col-sm-6 product-item fontss">
                        <div class="photo-wrapper   ">
                            <?= Html::a("<div class=\"photo-wrapper\">" . Html::img($recommendedProduct->getUploadedFileUrl('product_picture'), ['class' => 'cover-img']) . "</div>", ['product/forsell', 'pid' => $recommendedProduct->product_id]) ?>
                        </div>
                        <div class="item-name fontsn"
                             title="<?= $recommendedProduct->product_name ?>"><?= $recommendedProduct->product_name ?></div>
                        <div class="item-counter-type item-ui-a">
                            <div class="row">
                                <!-- DateTime  -->
                                <div class="col-md-3 col-xs-3 text-center fNumber">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button type="button"
                                            class="btn btn-danger btn-hammer fNumber"><?= Html::img('@web/img/ui/hammer.png') ?>
                                        <span>bidding $<?= $recommendedProduct->product_price ?></span></button>
                                </div>
                            </div>
                            <div class="row">
                                <!-- Item Fav / limit info -->
                ...
                <?php foreach ($categories as $category) : ?>
                    ...
                    <div class="category-item1 category-item">
                        <h2 class="fTitle category-list-title"
                            ...
                            <?= Html::img($category->getUploadedFileUrl('product_category_icon')) ?>
                            <span><?= $category->product_category_name ?></span><a>
                                <button type="button" class="btn btn-default fNormal">more</button>
                            </a></h2>
                            ...
                            <?php foreach ($category->products as $product) : ?>
                                <?php if (!empty($product->product_bidding_date)) : ?>
                                    <div class="col-lg-3 col-sm-4 col-xs-6 product-item fontss">
                                        <?= Html::a("<div class=\"photo-wrapper\">" . Html::img($product->getUploadedFileUrl('product_picture'), ['class' => 'cover-img']) . "</div>", ['product/bidding', 'pid' => $product->product_id]) ?>
                                        <div class="item-name fontsn"
                                             title="<?= $product->product_name ?>"><?= $product->product_name ?></div>
                                        <div class="item-price fonts0"><span
                                                class="item-price1 text-right fontsl"><?= $product->product_price ?></span><span
                                                class="item-price2 text-left fontsn"><?= $product->product_price ?></span>
                                        </div>
