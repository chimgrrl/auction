    ...
    jQuery.fn.highCheckTree = function(settings){
        ...
        function getChildrenHtml(treesdata){
            ...
            for(i = 0; i < len; i++){
               ...
               result += '<li rel="' + node.item.id + '"><div class="arrow ' + arrowClass + '"></div><div class="checkbox2 ' + checkClass + '"></div><label>' + 
        ...
        container.off('selectchange', '.checkbox2').on('selectchange', '.checkbox2', function () {
            ...
            var $all = $(this).siblings('ul').find('.checkbox2');
        ...
        container.off('click', '.checkbox2').on('click', '.checkbox2', function () {
            var $li = $(this).parent();
            var dataSource = $.data($tree, $li.attr('rel'));
            if (!$li.hasClass('updated')) {
            ...
            if ($(this).hasClass('checked')) {
                ...
                $(this).siblings('ul').find('.checkbox2').not('.checked').removeClass('half_checked').addClass('checked').each(function () {
                ...
                $(this).siblings('ul').find('.checkbox2').filter('.checked').removeClass('half_checked').removeClass('checked').each(function () {
                    var $subli = $(this).parent();
            ...
            $(this).parents('ul').siblings('.checkbox2').trigger('selectchange');
        });

        //click label also trigger check action
        container.off('click', 'label').on('click', 'label', function () {
            $(this).prev('.checkbox2').trigger('click');
        });
